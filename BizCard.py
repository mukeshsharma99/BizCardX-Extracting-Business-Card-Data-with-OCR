...
icon = Image.open("C:\\Users\\hp.MUKESH-LF4B6N6\\Desktop\\streamlit proj\\myenv\\BizCard\\icon.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Mukesh sharma",
                   page_icon=icon,
                   layout="wide",
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                       ...
                       styles={"nav-link": {"font-size": "25px", "text-align": "centre", "margin": "0px", "--hover-color": "#AB63FA", "transition": "color 0.3s ease, background-color 0.3sease"},
                               "icon": {"font-size": "25px"},
...
if selected == "Home":
    ...
    with col2:
        st.image("C:\\Users\\hp.MUKESH-LF4B6N6\\Desktop\\streamlit proj\\myenv\\BizCard\\home.png")
